package com.vonailabs.hireqa.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.vonailabs.hireqa.service.EmailAlreadyUsedException ||
            ex instanceof com.vonailabs.hireqa.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.vonailabs.hireqa.service.InvalidPasswordException
